...
# installed.
TK_PREFIX='/home/forster/paschen_neoantigens/Neoantigen_Prediction/.snakemake/conda/824e66c9'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/forster/paschen_neoantigens/Neoantigen_Prediction/.snakemake/conda/824e66c9'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/forster/paschen_neoantigens/Neoantigen_Prediction/.snakemake/conda/824e66c9/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/forster/paschen_neoantigens/Neoantigen_Prediction/.snakemake/conda/824e66c9/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/forster/paschen_neoantigens/Neoantigen_Prediction/.snakemake/conda/824e66c9/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/home/forster/paschen_neoantigens/Neoantigen_Prediction/.snakemake/conda/824e66c9/lib/libtkstub8.6.a'
