rule annotate_variants:
    ...
    output:
        ...
        stats=report("results/calls/{group}.{scatteritem}.stats.html", caption="../report/stats.rst", category="QC")
    params:
...
rule annotate_strelka_variants:
    ...
    output:
        ...
        stats=report("results/strelka/{calls}.annotated.stats.html", caption="../report/stats.rst", category="QC")
    params:
        # Pass a list of plugins to use, see https://www.ensembl.org/info/docs/tools/vep/script/vep_plugins.html
        # Plugin args can be added as well, e.g. via an entry "MyPlugin,1,FOO", see docs.
        plugins=[],#config["annotations"]["vep"]["plugins"],
